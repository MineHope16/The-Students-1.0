"""
Name: DATTARAM SANTOSH KOLTE
Project Partner: SAYALI SARJERAO KUMBHAR ( 225357 )
Roll No.: 225354
Batch: S.Y.B.Sc-IT

Topic Name: The Students Application
Project Description: Student Database Management using user authentication window.
...
def app_window():
    ...
    #Credit Label
    l2=Label(win1,text="designed by DATTARAM KOLTE & SAYALI KUMBHAR",font=("calibri",8,"bold"),bg="LightBlue")
